 ...
 */
public class VideoChannelRequest<T> extends GsonRequest<T> {
    private HashMap mParams, mHeader;

    public VideoChannelRequest(int method, Type reflectType, String url, Response.Listener successListener, Response.ErrorListener listener) {
        super(method, reflectType, url, successListener, listener);
    }

    public VideoChannelRequest(int method, Class clazz, String url, Response.Listener successListener, Response.ErrorListener listener) {
