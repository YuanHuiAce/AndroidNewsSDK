...
public class SelectedGridView extends GridView {
	...
	public SelectedGridView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public SelectedGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
		...
		ChannelSelectedAdapter mDragAdapter = (ChannelSelectedAdapter) getAdapter();
		//显示刚拖动的ITEM
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				itemTotalCount = SelectedGridView.this.getCount();
...
//		this.windowParams.y = (y - this.win_view_y + this.viewY);//位置的y值
	...
	private void hideDropItem() {
		((ChannelSelectedAdapter) getAdapter()).setShowDropItem(false);
	}
