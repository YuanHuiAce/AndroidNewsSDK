...
public class ColorTrackTabLayout extends TabLayout {
    ...
    */
    ...
    public void addTab(@NonNull Tab tab, int position, boolean setSelected) {
        ...
        ColorTrackView colorTrackView = (ColorTrackView) view.findViewById(R.id.tv_tabtitle);
        ...
        setTabWidth(position, view);
    }

    private void setTabWidth(int position, View colorTrackView) {
