...
public class NewsDetailListView extends ListView implements OnScrollListener {
    ...
    public NewsDetailListView(Context context, AttributeSet attrs,
                              int defStyle) {
    ...
    public void init(Context context) {
        mDefaultImageViewHeight = DensityUtil.dip2px(context,180);
    }
