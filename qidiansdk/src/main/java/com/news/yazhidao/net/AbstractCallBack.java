 ...
 */
public abstract class AbstractCallBack<T> implements com.news.yazhidao.net.ICallback<T> {
    private String path;
    private boolean isCanceled;
    private boolean isForceCanceled;
    public void checkIsCanceled() throws com.news.yazhidao.net.MyAppException {
        if(isCanceled){
